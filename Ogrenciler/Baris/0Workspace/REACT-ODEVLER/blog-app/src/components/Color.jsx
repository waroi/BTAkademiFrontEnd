const Color = {
  ...
  warning: `background: linear-gradient(to bottom right, #ffc107,#282c34); color:#F8F9FA;`,
  dark: `background: linear-gradient(to bottom right, #3c3c3c,#282c34); color:#F8F9FA;`,
};
